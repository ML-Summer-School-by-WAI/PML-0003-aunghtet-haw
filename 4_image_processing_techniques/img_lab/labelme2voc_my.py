...
def main():
    ...
    parser.add_argument("output_dir", nargs="?", help="Output dataset directory")
    parser.add_argument(
        "--labels", help="Labels file or comma separated text", required=False
    )
    parser.add_argument(
    ...
    if not args.input_dir:
        args.input_dir = input("Enter input directory path: ").strip()
    if not args.output_dir:
        args.output_dir = input("Enter output directory path: ").strip()
    if not args.labels:
        args.labels = input("Enter labels (comma-separated or path to labels.txt): ").strip()
